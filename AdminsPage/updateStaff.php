<?php 
      session_start();
      include 'DBValidator/updateStaffInfo.php';
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Update Staffs Info</h5>
              </div>
              <div class="card-body">
                <form action="updateStaff.php" method="post">
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        <input type="submit" name="update" class="form-control" value="Update Staff" style="background-color:red;">
                  </div>
                  </div>
                  </div>
                </form>
